...
class sample_YOLOV7_NMS_ONNX(object):
    ...
    def yolo_inference(self):
        ...
        print("------------yolo_result, resized_image:", len(self.yolo_result), len([self.yolo_model]))
    ...
    def postprocess_inference(self):
        print("------------postprocess_input:", len(self.postprocess_input))
    ...
    def postprocess_get_reslut(self, src_image_path):
        print("------------postprocess_result:", len(self.postprocess_result))
